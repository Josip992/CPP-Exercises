...
////broj odigranih utakmica, broj pobjeda, poraza, neriješenog rezultata, broj bodova i gol - razlika.
////Napisati klasu koja predstavlja reprezentaciju.
////Napisati funkciju koja će napuniti vektor reprezentacija podacima iz datoteke, te drugu koja će ispisati
////parove osmine finala, ako znamo da se u osmini finala kombiniraju po dvije grupe abecednim redom oynake
////gruupe(A i B, C i D itd.) tako da vodeći iz jedne grupe igra s drugoplasiranim iz druge grupe.
////
//
//#include<iostream>
//#include<string>
